...
def main():
    ...
    for i in range(numberOfPoints):
        point = 2 * [0]
        point[0], point[1] = eval(input("Enter coordinates separated by a coma: "))
        points.append(point)
    ...
    #Display result
    print("The closest two points are (" + str(points[p1][0]) + "," + str(points[p1][1]) + ") and (" + str(points[p2][0]) + "," + str(points[p2][1]) + ")")
